...
<style type="text/css" media="screen">
  .subpageWrapper{
    background-color:#411F52;
  }
  
</style>

<div class="subpageWrapper" style="background:url(<?php bloginfo('template_directory');?>/images/backgrounds/LS_Dining.png) no-repeat;">
  ...
  <div class="subpageContentWrapper">
    <div class="subpageCopy">    
      ...
      <div class="jsSubContent jsc_2">
        ...
        <div class="jsSubContentText single" >
          <div class="jsSubContentTitle">Kathleen's</div>
          <p>
      ...
      <div class="jsSubContent jsc_3">
        ...
        <div class="jsSubContentText single">
          <div class="jsSubContentTitle">Promenade Room</div>
          <p>
      ...
      <div class="jsSubContent jsc_4">
        ...
        <div class="jsSubContentText single">
          <div class="jsSubContentTitle">Canterbury Room</div>
          <p>
      ...
      <div class="jsSubContent jsc_5">
        ...
        <div class="jsSubContentText single">  
          <div class="jsSubContentTitle">Sidewalk Cafe</div> 
          <p>
