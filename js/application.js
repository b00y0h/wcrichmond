    ...
    $(document).ready(function(){
        $('.thumbnail-wrap .button').each(function() {
		        ...
		        if(vid_string.indexOf('youtube') !== -1) {
		            ...
		            vid_html = '<iframe class="vid-frame" width="294" height="164" src="http://www.youtube.com/embed/' + vid_string + '?rel=0&amp;autoplay=0&amp;wmode=transparent" frameborder="0"></iframe>';
		            ...
		            vid_html = '<iframe class="vid-frame" src="http://player.vimeo.com/video/' + vid_string + '?portrait=0&amp;autoplay=0" width="294" height="164" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
		        }
