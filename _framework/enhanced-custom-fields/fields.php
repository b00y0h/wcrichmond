...
class ECF_FieldColor extends ECF_Field {
	...
	function init() {
		if (defined('WP_ADMIN') && WP_ADMIN) {
			...
			wp_enqueue_script('custom-colorpicker', get_stylesheet_directory_uri() . '/lib/enhanced-custom-fields/colorpicker/colorpicker.js');
			wp_enqueue_style('custom-colorpicker', get_stylesheet_directory_uri() . '/lib/enhanced-custom-fields/colorpicker/colorpicker.css');
		}
		ECF_Field::init();
	...
	function print_js() {
        ...
        <script type="text/javascript" charset="utf-8">
            jQuery(function ($) {
                ...
                $('select[name="_slide_link_gallery"]').parents('.ecf-field-container').hide();
                ...
                function adjust_panels(selectVal){
                	if (selectVal == ''){
	            		...
	            		$('input[name="_slide_link_custom"]').parents('.ecf-field-container').fadeIn('fast');
	            		$('select[name="_slide_link_page"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_post"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_gallery"]').parents('.ecf-field-container').hide();
                		$('select[name="_slide_link_video"]').parents('.ecf-field-container').hide();
	            		...
	            		$('select[name="_slide_link_page"]').parents('.ecf-field-container').fadeIn('fast');
	            		$('input[name="_slide_link_custom"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_post"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_gallery"]').parents('.ecf-field-container').hide();
                		$('select[name="_slide_link_video"]').parents('.ecf-field-container').hide();
	            		...
	            		$('select[name="_slide_link_post"]').parents('.ecf-field-container').fadeIn('fast');
	            		$('input[name="_slide_link_custom"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_page"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_gallery"]').parents('.ecf-field-container').hide();
                		$('select[name="_slide_link_video"]').parents('.ecf-field-container').hide();
	            		...
	            		$('select[name="_slide_link_gallery"]').parents('.ecf-field-container').fadeIn('fast');
	            		$('input[name="_slide_link_custom"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_page"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_post"]').parents('.ecf-field-container').hide();
                		$('select[name="_slide_link_video"]').parents('.ecf-field-container').hide();
	            		...
	            		$('select[name="_slide_link_video"]').parents('.ecf-field-container').fadeIn('fast');
	            		$('input[name="_slide_link_custom"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_page"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_gallery"]').parents('.ecf-field-container').hide();
                		$('select[name="_slide_link_post"]').parents('.ecf-field-container').hide();
	            		...
	            		$('select[name="_slide_link_audio"]').parents('.ecf-field-container').fadeIn('fast');
	            		$('input[name="_slide_link_custom"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_page"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_gallery"]').parents('.ecf-field-container').hide();
                		$('select[name="_slide_link_video"]').parents('.ecf-field-container').hide();
	            		...
	            		$('select[name="_slide_link_event"]').parents('.ecf-field-container').fadeIn('fast');
	            		$('input[name="_slide_link_custom"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_page"]').parents('.ecf-field-container').hide();
	            		$('select[name="_slide_link_gallery"]').parents('.ecf-field-container').hide();
                		$('select[name="_slide_link_video"]').parents('.ecf-field-container').hide();
            ...
            jQuery(function ($) {
                ...
                function adjust_panels(selectVal){
	            	if (selectVal == 'audio'){
	            		...
	            		$('#slide_address_panel').hide();
	            		$('#slide_image_panel').hide();
	            	} else if (selectVal == 'map'){
	            		$('#slide_address_panel').fadeIn('fast');
	            		$('#slide_audio_panel').hide();
	            		$('#slide_video_panel').hide();
	            		$('#slide_image_panel').hide();
