...
class ECF_Panel {
	...
	function _attach_ecf_styling(){
		...
		wp_enqueue_style(
			'ecf_styles',
			"$theme_root/_framework/enhanced-custom-fields/tpls/style.css"
		);
	}
	function _attach() {
		if (isset($_GET['post'])) {
	    ...
	    wp_enqueue_script('ecf', get_stylesheet_directory_uri() . '/_framework/enhanced-custom-fields/tpls/ecf.js');
